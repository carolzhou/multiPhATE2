# multiPhATE v.1.50
/MultiPhATE/ - multiPhATE2 (beta version)
...
2) multiPhATE compares gene calls from multiple gene callers, generating several new gene-call sets: superset, consensus, commoncore.
