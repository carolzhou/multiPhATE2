# multiPhATE v.2.0
/MultiPhATE/ - multiPhATE2 (beta version) - This code is currently in revision. For a production version of multiPhATE, use the code at https://github.com/carolzhou/multiPhATE.git. 
