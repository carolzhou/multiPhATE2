...
for iLine in iLines:
    if VENN:
        if re.search ('^>',iLine):
            ...
            command = "python getAnnotations.py " + identifier  + ' ' + genomeDir 
